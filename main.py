...
def main():
    ...
    parser.add_argument("--mode", type=str, default="2d", choices=["2d", "3d"], help="Training mode: 2d or 3d")
    ...
    parser.add_argument("--num_patients", type=int, default=100, help="Number of patients to use for training")
    parser.add_argument("--min_mask_pixels", type=int, default=50, help="Number of patients to use for training")
    ...
    parser.add_argument("--reset_cache", action="store_true", help="Reset the dataset file cache")
    parser.add_argument("--inference", action="store_true", help="Only run evaluation on test set using saved model")
    parser.add_argument(
        "--model",
        type=str,
        default="segresnet",
